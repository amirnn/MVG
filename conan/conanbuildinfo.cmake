...
###  NUMCPP
#################
set(CONAN_NUMCPP_ROOT "/Users/amirnourinia/.conan/data/numcpp/2.6.2/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_NUMCPP "/Users/amirnourinia/.conan/data/numcpp/2.6.2/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include")
set(CONAN_LIB_DIRS_NUMCPP )
set(CONAN_BIN_DIRS_NUMCPP )
set(CONAN_RES_DIRS_NUMCPP )
set(CONAN_SRC_DIRS_NUMCPP )
set(CONAN_BUILD_DIRS_NUMCPP "/Users/amirnourinia/.conan/data/numcpp/2.6.2/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/")
set(CONAN_FRAMEWORK_DIRS_NUMCPP )
set(CONAN_LIBS_NUMCPP )
set(CONAN_PKG_LIBS_NUMCPP )
set(CONAN_SYSTEM_LIBS_NUMCPP )
set(CONAN_FRAMEWORKS_NUMCPP )
set(CONAN_FRAMEWORKS_FOUND_NUMCPP "")  # Will be filled later
set(CONAN_DEFINES_NUMCPP )
set(CONAN_BUILD_MODULES_PATHS_NUMCPP )
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_NUMCPP )

set(CONAN_C_FLAGS_NUMCPP "")
set(CONAN_CXX_FLAGS_NUMCPP "")
set(CONAN_SHARED_LINKER_FLAGS_NUMCPP "")
set(CONAN_EXE_LINKER_FLAGS_NUMCPP "")

# For modern cmake targets we use the list variables (separated with ;)
set(CONAN_C_FLAGS_NUMCPP_LIST "")
set(CONAN_CXX_FLAGS_NUMCPP_LIST "")
set(CONAN_SHARED_LINKER_FLAGS_NUMCPP_LIST "")
set(CONAN_EXE_LINKER_FLAGS_NUMCPP_LIST "")

# Apple Frameworks
conan_find_apple_frameworks(CONAN_FRAMEWORKS_FOUND_NUMCPP "${CONAN_FRAMEWORKS_NUMCPP}" "_NUMCPP" "")
# Append to aggregated values variable
set(CONAN_LIBS_NUMCPP ${CONAN_PKG_LIBS_NUMCPP} ${CONAN_SYSTEM_LIBS_NUMCPP} ${CONAN_FRAMEWORKS_FOUND_NUMCPP})
...
set(CONAN_DEPENDENCIES opencv numcpp gtest eigen jasper libpng openexr libtiff quirc protobuf ade boost zlib libjpeg libdeflate xz_utils jbig zstd libwebp bzip2 libbacktrace libiconv)
...
macro(conan_define_targets)
    ...
    set(_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES "${CONAN_SYSTEM_LIBS_NUMCPP} ${CONAN_FRAMEWORKS_FOUND_NUMCPP} CONAN_PKG::boost")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES "${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES}")
    conan_package_library_targets("${CONAN_PKG_LIBS_NUMCPP}" "${CONAN_LIB_DIRS_NUMCPP}"
                                  CONAN_PACKAGE_TARGETS_NUMCPP "${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES}"
                                  "" numcpp)
    set(_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_DEBUG "${CONAN_SYSTEM_LIBS_NUMCPP_DEBUG} ${CONAN_FRAMEWORKS_FOUND_NUMCPP_DEBUG} CONAN_PKG::boost")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_DEBUG "${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_DEBUG}")
    conan_package_library_targets("${CONAN_PKG_LIBS_NUMCPP_DEBUG}" "${CONAN_LIB_DIRS_NUMCPP_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_NUMCPP_DEBUG "${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_DEBUG}"
                                  "debug" numcpp)
    set(_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_RELEASE "${CONAN_SYSTEM_LIBS_NUMCPP_RELEASE} ${CONAN_FRAMEWORKS_FOUND_NUMCPP_RELEASE} CONAN_PKG::boost")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_RELEASE "${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_RELEASE}")
    conan_package_library_targets("${CONAN_PKG_LIBS_NUMCPP_RELEASE}" "${CONAN_LIB_DIRS_NUMCPP_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_NUMCPP_RELEASE "${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_RELEASE}"
                                  "release" numcpp)
    set(_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_NUMCPP_RELWITHDEBINFO} ${CONAN_FRAMEWORKS_FOUND_NUMCPP_RELWITHDEBINFO} CONAN_PKG::boost")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_RELWITHDEBINFO "${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_RELWITHDEBINFO}")
    conan_package_library_targets("${CONAN_PKG_LIBS_NUMCPP_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_NUMCPP_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_NUMCPP_RELWITHDEBINFO "${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_RELWITHDEBINFO}"
                                  "relwithdebinfo" numcpp)
    set(_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_MINSIZEREL "${CONAN_SYSTEM_LIBS_NUMCPP_MINSIZEREL} ${CONAN_FRAMEWORKS_FOUND_NUMCPP_MINSIZEREL} CONAN_PKG::boost")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_MINSIZEREL "${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_MINSIZEREL}")
    conan_package_library_targets("${CONAN_PKG_LIBS_NUMCPP_MINSIZEREL}" "${CONAN_LIB_DIRS_NUMCPP_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_NUMCPP_MINSIZEREL "${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_MINSIZEREL}"
                                  "minsizerel" numcpp)

    add_library(CONAN_PKG::numcpp INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::numcpp PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_NUMCPP} ${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_NUMCPP_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_NUMCPP_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_NUMCPP_LIST}>

                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_NUMCPP_RELEASE} ${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_RELEASE}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_NUMCPP_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_NUMCPP_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_NUMCPP_RELEASE_LIST}>>

                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_NUMCPP_RELWITHDEBINFO} ${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_RELWITHDEBINFO}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_NUMCPP_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_NUMCPP_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_NUMCPP_RELWITHDEBINFO_LIST}>>

                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_NUMCPP_MINSIZEREL} ${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_MINSIZEREL}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_NUMCPP_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_NUMCPP_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_NUMCPP_MINSIZEREL_LIST}>>

                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_NUMCPP_DEBUG} ${_CONAN_PKG_LIBS_NUMCPP_DEPENDENCIES_DEBUG}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_NUMCPP_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_NUMCPP_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_NUMCPP_DEBUG_LIST}>>)
    set_property(TARGET CONAN_PKG::numcpp PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CONAN_INCLUDE_DIRS_NUMCPP}
                                                                      $<$<CONFIG:Release>:${CONAN_INCLUDE_DIRS_NUMCPP_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_INCLUDE_DIRS_NUMCPP_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_INCLUDE_DIRS_NUMCPP_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_INCLUDE_DIRS_NUMCPP_DEBUG}>)
    set_property(TARGET CONAN_PKG::numcpp PROPERTY INTERFACE_COMPILE_DEFINITIONS ${CONAN_COMPILE_DEFINITIONS_NUMCPP}
                                                                      $<$<CONFIG:Release>:${CONAN_COMPILE_DEFINITIONS_NUMCPP_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_COMPILE_DEFINITIONS_NUMCPP_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_COMPILE_DEFINITIONS_NUMCPP_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_COMPILE_DEFINITIONS_NUMCPP_DEBUG}>)
    set_property(TARGET CONAN_PKG::numcpp PROPERTY INTERFACE_COMPILE_OPTIONS ${CONAN_C_FLAGS_NUMCPP_LIST} ${CONAN_CXX_FLAGS_NUMCPP_LIST}
                                                                  $<$<CONFIG:Release>:${CONAN_C_FLAGS_NUMCPP_RELEASE_LIST} ${CONAN_CXX_FLAGS_NUMCPP_RELEASE_LIST}>
                                                                  $<$<CONFIG:RelWithDebInfo>:${CONAN_C_FLAGS_NUMCPP_RELWITHDEBINFO_LIST} ${CONAN_CXX_FLAGS_NUMCPP_RELWITHDEBINFO_LIST}>
                                                                  $<$<CONFIG:MinSizeRel>:${CONAN_C_FLAGS_NUMCPP_MINSIZEREL_LIST} ${CONAN_CXX_FLAGS_NUMCPP_MINSIZEREL_LIST}>
                                                                  $<$<CONFIG:Debug>:${CONAN_C_FLAGS_NUMCPP_DEBUG_LIST}  ${CONAN_CXX_FLAGS_NUMCPP_DEBUG_LIST}>)
    ...
    set(CONAN_TARGETS CONAN_PKG::opencv CONAN_PKG::numcpp CONAN_PKG::gtest CONAN_PKG::eigen CONAN_PKG::jasper CONAN_PKG::libpng CONAN_PKG::openexr CONAN_PKG::libtiff CONAN_PKG::quirc CONAN_PKG::protobuf CONAN_PKG::ade CONAN_PKG::boost CONAN_PKG::zlib CONAN_PKG::libjpeg CONAN_PKG::libdeflate CONAN_PKG::xz_utils CONAN_PKG::jbig CONAN_PKG::zstd CONAN_PKG::libwebp CONAN_PKG::bzip2 CONAN_PKG::libbacktrace CONAN_PKG::libiconv)
